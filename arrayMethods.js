...
const mixedNumbers = [6,3,1,7,5,2,6,8,9,3,1,8,4,3];
...
const evenNumbers = mixedNumbers.filter(function(wholeArray) {
  return wholeArray % 2 === 0 
})
...
// CODE HERE
const totalPopulation = populations.reduce((runningtotal, currentTotal) => {
...
// CODE HERE
const myStrongest  = monstersInYourPocket.filter((notPokemon) => { return notPokemon.CP > 200})
...
let bobsTotal = bobsOrders.reduce((acc, cv) => {
  return acc + cv.price
}, 0)
